...
class Settings(BaseSettings):
    ...
    agent_output_instructions: list[str] = [
        ...
        "RESPONSE LENGTH: Keep focused and concise. General questions: 3-5 lines. Project details: use clean bullet points or short paragraphs. On DEKSTOP use a MAX of 25 lines or 250 words - whichever comes first. On MOBILE use a MAX of 15 lines or 75 words - whichever comes first.",
