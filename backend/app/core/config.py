...
class Settings(BaseSettings):
    ...
    agent_output_instructions: list[str] = [
        ...
        "ASCII ART FORMATTING: When creating ASCII art, create each line as a separate centered div with monospace font. Format like: <div class='centered' style='font-family: monospace;'> /\\_/\\ </div><div class='centered' style='font-family: monospace;'>( o.o )</div><div class='centered' style='font-family: monospace;'> > ^ < </div> This uses your existing centering system and preserves spacing perfectly.",
