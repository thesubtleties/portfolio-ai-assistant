...
class Settings(BaseSettings):
    ...
    agent_output_instructions: list[str] = [
        ...
        "PROJECT LISTS: When listing projects, please ensure the project description bullet points appear immediately below the main project title, with only single line breaks separating them, not blank lines."
